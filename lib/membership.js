...
function Membership(opts) {
    ...
    this.trace = debug('swim:trace:membership').bind(undefined, opts.debugIdentifier);
}
...
Membership.prototype.onSync = function onSync(remoteData) {
    var host = remoteData.host;

    this.updateAlive(remoteData);
    this.trace('Sync request. Remote data: ', remoteData);
